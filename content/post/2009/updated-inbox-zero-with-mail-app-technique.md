...
{{< img src="/images/Automator_select_service.jpg"  alt="Automator Create a new Service Workflow"   >}}

Select "Utilities" and then drag in "Run Applescript" to the window on the right.

{{< img src="/images/automator-drag-run-applescript.jpg"  alt="Automator: Run Applescript"   >}}
...
{{< img src="/images/automator_archive.jpg"  alt="Automator: Archive Applescript"   >}}
...
{{< img src="/images/Keyboard-Shortcuts-Archive-Mail.jpg"  alt="Keyboard Shortcuts: Archive Mail"   >}}
